...
/*
*  Function: loadHistoryDataTestVersion(MqlRates& historyData[],
                             ENUM_TIMEFRAMES timeFrame);
*  Function loads history data based on given input
*/
bool loadHistoryDataTestVersion(MqlRates &historyData[], datetime tradeTime, ENUM_TIMEFRAMES timeFrame)
{
   datetime _fromDate;

   if (timeFrame == PERIOD_MN1) {
      _fromDate = tradeTime - 12960000;
   }

   if (timeFrame == PERIOD_W1) {
      _fromDate = tradeTime - 3024000;
   }
